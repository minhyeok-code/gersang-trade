...
import org.example.gersangtrade.auth.cookie.RefreshTokenCookieManager;
import org.example.gersangtrade.auth.jwt.JwtTokenizer;
import org.example.gersangtrade.auth.security.CustomUserPrincipal;
...
public class OAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        refreshTokenCookieManager.set(response, refreshToken,
                jwtTokenizer.getRefreshTokenExpiryMs() / 1000);
