 ...
 * @param elementValue    속성값 (MercenaryStat ELEMENT_VALUE, 무속성 또는 미입력 시 null)
...
public record MercenaryResponse(
    ...
    public static MercenaryResponse of(Mercenary m, Integer resistPierce, Integer elementValue) {
